let todos = [
  ...
  {id: 3, title:"einkauf", isDone:false},
...
function printTasks(){
  ...
  html += "<div class='task'style='background-color:" + style + "'>" + element.title + " - " + element.isDone + 
          "<div onClick='setIsDone("+ element.id + 
          ")'>Done</div><div onClick='deleteTask("+ element.id + ")'>Delete</div></div>"
